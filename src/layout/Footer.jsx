    ...
    <footer   className="w-full relative border-t border-slate-300/40 bg-gradient-to-b from-white to-slate-50/70 backdrop-blur-[1px]">
      ...
      <div className="pointer-events-none">
        <button
          ...
          onClick={scrollToTop}
          className={`fixed bottom-36 animate-bounce right-[50%] z-40 inline-flex h-10 w-10 items-center justify-center rounded-full bg-primary text-white shadow-lg shadow-primary/30 ring-1 ring-white/50 transition-all duration-300   ${
