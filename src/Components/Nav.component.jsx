					...
					<div className="">
						<ul className="flex  space-x-7">
							<li
								...
								className=" text-gray-400  tracking-wide select-none hover:text-yellow-400  font-medium   hover:border-b-2 transition-transform  duration-500  hover:border-b-yellow-400  active:text-yellow-500   ">
								Home
							</li>
							<li
