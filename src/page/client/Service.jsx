    ...
    <section id="service" data-aos="fade-left" className="py-20 ">
      <div className="mx-auto  px-4">
        <div className="flex flex-col items-center text-center gap-3 mb-12">
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-black dark:text-slate-100">What I can do for you</h2>
        </div>
            ...
            >
              <Card className="group h-full border-gray-200 hover:border-primary/40 transition-colors duration-300 shadow-sm">
                <CardHeader className="items-center text-center">
                  ...
                  <CardTitle className="text-lg md:text-xl text-black dark:text-slate-100 mt-2">{serviceItem.title}</CardTitle>
                </CardHeader>
                <CardContent>
