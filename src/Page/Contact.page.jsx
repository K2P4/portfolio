...
const ContactPage = () => {
	...
	return (
		<div className="ContainerResponsive flex  gap-14 flex-col justify-center">
			<div className="header  flex items-center flex-col mx-auto ">
				...
				<h1 className=" text-2xl text-gray-300  ">I Want to Hear from you</h1>
			</div>
			...
			<div id="contact" className="flex   items-start">
				<div
					...
					<div className="flex items-start   gap-5">
						...
						<p className="text-gray-400 cardFont  w-[72%] tracking-wide ">
					...
					<div className="flex items-center   gap-5">
						...
						<p className="text-gray-400 tracking-wider cardFont  w-[72%]  ">
							pthuya381@gmail.com
						</p>
					</div>
				</div>
							...
							<>
								<Form className="flex flex-col gap-3">
									...
									<Button
										...
										type="submit"
										className="text-black ms-auto cardFont  active:scale-95 mt-5  bg-yellow-500 w-[30%]  hover:bg-yellow-500 rounded-lg   text-center  font-semibold">
										{isSubmitting ? (
