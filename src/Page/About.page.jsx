...
const AboutPage = () => {
  ...
  return (
    <div className="  ">
      <div
        id="about"
        className={`ContainerResponsive h-screen  ${
          showAnimation &&
      ...
      >
        <div className="flex  sm:gap-2 lg:gap-3 items-center  ">
          <svg
            className=" w-[90%]  lg:w-[55%]  h-screen   "
            xmlns="http://www.w3.org/2000/svg"
            id="fbc9d7d4-f833-48c3-bed3-97c149712705"
            data-name="Layer 1"
            width="786.81995"
            height="572.25773"
          ...
          <div className=" sm:w-[70%] lg:w-[50%] text-left sm:px-3 lg:px-5">
            ...
            <p className="  sm:mt-2  lg:mt-5 sm:leading-7   lg:leading-8 sm:text-sm lg:text-md font-medium text-gray-300 tracking-tight lg:tracking-wide   text-justify lg:text-justify ">
              ...
              software development, and I am continuously learning and improving
      ...
      >
        <div className="w-full border-b pb-2 border-[#23053a] ">
          <img
            className="mx-auto    border-b border  shadow-xl shadow-[#2c1c38]   object-cover mt-4    w-[150px] h-[150px]  rounded-md   opacity-80  text-center  "
        ...
        <div className="">
          ...
          <p className=" my-2 leading-7 cardFont text-sm font-medium text-gray-400 tracking-normal  text-justify ">
            <span className="tracking-widest w-full  block text-center  mx-auto text-yellow-400 font-bold">
          ...
          <div className=" text-gray-400 py-5 rounded-lg w-full ">
            <div className="grid grid-cols-[30px_70px_10px_auto] items-center gap-x-2 py-2 text-left">
          ...
          {/* <div className="flex flex-col space-y-5 cardFont mt-7">
						<div className="flex py-2 border-[#25093b] border-b  items-center  justify-between ">
							<div className="flex w-[54%] items-center gap-2">
								<svg
									...
									viewBox="0 0 24 24"
									fill="currentColor"
									className="w-5 text-yellow-400 h-5">
									<path
										fillRule="evenodd"
								...
								<p className=" text-gray-400 tracking-wide text-md font-medium">
									Name
								</p>
							</div>

							<p className="text-gray-400 w-[75%]  gap-2 flex items-center tracking-wide text-md  font-medium">
								<span className="text-yellow-400 text-left  ">: </span> Phyo
								Thura
							</p>
						</div>
						...
						<div className="flex py-2 border-[#25093b]  border-b  items-center  justify-between ">
							...
							<p className="text-gray-400 w-[85%]  gap-2 flex items-center tracking-wide text-md  font-medium">
						...
						<div className="flex py-2 border-[#25093b]  border-b  items-center  justify-between ">
							...
							<p className="text-gray-400 w-[60%]  gap-2 flex items-center tracking-wide text-md  font-medium">
								<span className="text-yellow-400  text-left  ">: </span>{" "}
								pthya381@gmail.com
							</p>
						</div>
          ...
          <div className="flex gap-5   mb-40 align-middle items-center ">
            <div className="flex items-center gap-2">
              ...
              <p className="text-gray-400  cardFont  tracking-wide text-md  font-medium">
                Music
              </p>
            </div>
