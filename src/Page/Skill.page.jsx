...
const SkillPage = () => {
  return (
    <div className="ContainerResponsive select-none gap-14 sm:gap-0 flex flex-col justify-center   ">
      <h1 className="text-yellow-400     sm:ms-10 sm:mb-10   mt-60 sm:mt-0  text-2xl  sm:text-3xl header border-b-2 sm:w-[13%] lg:w-[20%]  border-b-yellow-400 pb-1">
        Skill-Set
      </h1>
      ...
      >
	<CarouselContent className="    flex    items-center    gap-20 mx-auto  sm:gap-16 w-[90%]  sm:w-[50%] lg:w-[20%] ">
