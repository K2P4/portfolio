	...
	return (
		<div className="ContainerResponsive flex flex-col justify-center   ">
			...
			<Carousel
				...
				<CarouselPrevious className="bg-[#2c173b] duration-300 hover:bg-[#37174e] hover:border-[#37174e] border-[#2c173b]" />
				<CarouselNext className="bg-[#2c173b] duration-300 hover:bg-[#37174e] hover:border-[#37174e] border-[#2c173b]" />
			</Carousel>
		</div>
	);
};
