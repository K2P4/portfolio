export const projects = [
  {
    ...
    githubUrl: "https://github.com/K2P4/nodejs_ecommerce",
...

  {
    title: "Zoya Blog",
    description:
      "Travel blog site with modern UI, blog content, and e-commerce features.",
...

  {
    ...
    description:
      "App for task tracking with user auth, duration, and status dashboard.",
    techStack: [
      "React",
      "Redux",
      "InertiaJS",
    ...
    features: [
      ...
      "Track task duration",
      "Status-based dashboard (To-do, In Progress, Done)",
    ],
    githubUrl: "https://github.com/K2P4/addToDoList-reactInteria_laravel",
    demoUrl: "",
...

  {
    ...
    description:
      "Interactive quiz app with real-time feedback and smooth UX/UI.",
